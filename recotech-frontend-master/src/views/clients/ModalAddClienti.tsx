...
const validationSchema = Yup.object().shape({
    ...
    vat: Yup.string().when('type', (type: any) =>
        type === 'COMPANY'
            ? Yup.string().required('VAT este necesar pentru persoane juridice')
    ...
    billingPostalCode: Yup.string().required(
        'Codul poștal de facturare este necesar',
    ),
    ...
    shippingPostalCode: Yup.string().required(
        'Codul poștal de livrare este necesar',
    ),
})
